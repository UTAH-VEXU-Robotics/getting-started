...
sudo apt -y install ros-melodic-controller-manager ros-melodic-teleop-twist-joy ros-melodic-robot-state-publisher ros-melodic-message-to-tf ros-melodic-joint-state-controller
...
#cv
sudo apt -y install ros-melodic-image-transport 
